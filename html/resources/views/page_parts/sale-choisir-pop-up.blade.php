    ...
    <form action="{{ route('send-choisir') }}" method="POST" class="saleChoisirPopUp__form">
        ...
        <div class="saleChoisirPopUp__form--row">
            <div class="saleChoisirPopUp__form--group">
                <label for="choisir-pack">Pack</label>
                @error('pack')
                    <p class="text__danger">{{ $message }}</p>
                @enderror
                <select name="pack" id="choisir-pack">
        ...
        <div class="saleChoisirPopUp__form--row">
            <div class="saleChoisirPopUp__form--group">
                <label for="choisir-company">Entreprise</label>
                @error('company')
                    <p class="text__danger">{{ $message }}</p>
                @enderror
                <input type="text" name="company" id="choisir-company" value="{{ old('company') ?: '' }}">
            </div>
            <div class="saleChoisirPopUp__form--group">
                <label for="choisir-name">Nom<span> *</span></label>
                @error('name')
                    <p class="text__danger">{{ $message }}</p>
                @enderror
                <input type="text" name="name" id="choisir-name" value="{{ old('name') ?: '' }}">
            </div>
        </div>
        <div class="saleChoisirPopUp__form--row">
            <div class="saleChoisirPopUp__form--group">
                <label for="choisir-phone">Téléphone<span> *</span></label>
                @error('phone')
                    <p class="text__danger">{{ $message }}</p>
                @enderror
                <input type="text" name="phone" id="choisir-phone" value="{{ old('phone') ?: '' }}">
            </div>
            <div class="saleChoisirPopUp__form--group">
                <label for="choisir-email">E-mail<span> *</span></label>
                @error('email')
                    <p class="text__danger">{{ $message }}</p>
                @enderror
                <input type="text" name="email" id="choisir-email" value="{{ old('email') ?: '' }}">
            </div>
        </div>
        ...
        <div class="saleChoisirPopUp__form--row">
            <div class="saleChoisirPopUp__form--group">
                ...
                @error('company')
                    <p class="text__danger">{{ $message }}</p>
                @enderror
                <input aria-label="Entreprise" type="text" name="company" id="company" value="{{ old('company') ?: '' }}">
            </div>
            <div class="saleChoisirPopUp__form--group">
