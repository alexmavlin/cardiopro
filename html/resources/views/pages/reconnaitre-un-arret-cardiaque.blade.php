...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/reconnaitre_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/reconnaitre_formuleLocation_600.webp') }} 700w,
                    {{ asset('images/content/reconnaitre_formuleLocation_400.webp 500w') }} 500w"
            src="{{ asset('images/content/reconnaitre_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">Comment reconnaitre un arrêt cardiaque ?</h1>
</section>
...
<div class="container">
    <div class="mastHead__inner">
        <img    src="{{ asset('images/content/logo_page.webp') }}"
            ...
            title="" 
            class="mastHead__img">
        <p class="mastHead__p">Lors d’une situation de malaise cardiaque, chaque seconde compte. Il est donc nécessaire de pouvoir reconnaitre rapidement les premiers signes d’arrêt cardiaque mais aussi de connaitre les gestes de premier secours afin de pouvoir agir rapidement et maintenir les chances de survie de la victime.</p>
    </div>
</div>
</section>
...
<section class="recognizeCardiac bg-blue">
    <div class="container">
        <div class="recognizeCardiac__inner">
            ...
            <div class="recognizeCardiac__list">
                <div class="recognizeCardiac__item">
                    <p class="recognizeCardiac__num">1</p>
                    <p class="recognizeCardiac__text">La victime est inconsciente, tombe évanouie</p>
                </div>
                <div class="recognizeCardiac__item">
                    <p class="recognizeCardiac__num">2</p>
                    <p class="recognizeCardiac__text">Ne réagit pas quand on la stimule ou qu’on lui parle</p>
                </div>
                <div class="recognizeCardiac__item">
                    <p class="recognizeCardiac__num">3</p>
                    <p class="recognizeCardiac__text">Ne respire pas ou pas bien (à grand-peine et comme pour tenter de compenser une soudaine insuffisance respiratoire)</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="whatAED__inner">
            <div class="whatAED__content">
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/reconnaitre_whatAED_1.webp') }}"
                            width="422"
                            height="288"
                            alt=""
                            title="" 
                ...
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/reconnaitre_whatAED_2.webp') }}"
                            width="439"
                            height="292"
                            alt=""
                            title="" 
