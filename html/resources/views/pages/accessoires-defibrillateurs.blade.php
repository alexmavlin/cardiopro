...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/accessoires_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/accessoires_formuleLocation_600.webp') }} 700w,
                    {{ asset('images/content/accessoires_formuleLocation_400.webp 500w') }} 500w"
            src="{{ asset('images/content/accessoires_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">Découvrez notre gamme d'accessoires pour défibrillateur : batteries, supports muraux, électrodes</h1>
</section>
...
<section class="defExplore bg-blue">
    <div class="container">
        <div class="defExplore__inner">
            ...
            <div class="defExplore__content">
                <div class="defExplore__item">
                    <div class="defExplore__title">
                        <p>PadPak adultes</p>
                    </div>
                    <img    src="{{ asset('images/content/accessoires_defExplore_1.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                    ...
                    <div class="defExplore__price__row">
                        <p class="defExplore__price">169</p>
                ...
                <div class="defExplore__item">
                    ...
                    <img    src="{{ asset('images/content/accessoires_defExplore_2.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                    ...
                    <div class="defExplore__price__row">
                        <p class="defExplore__price">189</p>
                        <p class="defExplore__euro">€</p>
                    </div>
                    <p class="defExplore__ht">HT*</p>
                    <p class="defExplore__dscr">*TVA à 20 %</p>
                ...
                <div class="defExplore__item">
                    ...
                    <img    src="{{ asset('images/content/accessoires_defExplore_3.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                    ...
                    <div class="defExplore__price__row">
                        <p class="defExplore__price">19</p>
                        <p class="defExplore__euro">€</p>
                    </div>
                    <p class="defExplore__ht">HT*</p>
                    <p class="defExplore__dscr">*TVA à 20 %</p>
                ...
                <div class="defExplore__item">
                    <div class="defExplore__title">
                        <p>Boitier Mural Aivia 100</p>
                    </div>
                    <img    src="{{ asset('images/content/accessoires_defExplore_4.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                ...
                <div class="defExplore__item">
                    <div class="defExplore__title">
                        <p>Boitier mural DAC-350</p>
                    </div>
                    <img    src="{{ asset('images/content/accessoires_defExplore_5.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                    ...
                    <div class="defExplore__price__row">
                        <p class="defExplore__price">300</p>
                        <p class="defExplore__euro">€</p>
                    </div>
                    <p class="defExplore__ht">HT*</p>
                    <p class="defExplore__dscr">*TVA à 20 %</p>
                ...
                <div class="defExplore__item">
                    ...
                    <img    src="{{ asset('images/content/accessoires_defExplore_6.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                    ...
                    <div class="defExplore__price__row">
                        <p class="defExplore__price">500</p>
                        <p class="defExplore__euro">€</p>
                    </div>
                    <p class="defExplore__ht">HT*</p>
                    <p class="defExplore__dscr">*TVA à 20 %</p>
                ...
                <div class="defExplore__item">
                    <div class="defExplore__title">
                        <p>Défibrillateur de Formation</p>
                    </div>
                    <img    src="{{ asset('images/content/accessoires_defExplore_7.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                ...
                <div class="defExplore__item">
                    <div class="defExplore__title">
                        <p>Signalétique autocollante</p>
                    </div>
                    <img    src="{{ asset('images/content/accessoires_defExplore_8.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                ...
                <div class="defExplore__item">
                    ...
                    <img    src="{{ asset('images/content/accessoires_defExplore_9.webp') }}"
                            width="190"
                            height="159"
                            alt=""
                            title="" 
                    ...
                    <div class="defExplore__price__row">
                        <p class="defExplore__price">95</p>
                        <p class="defExplore__euro">€</p>
                    </div>
                    <p class="defExplore__ht">HT*</p>
                    <p class="defExplore__dscr">*TVA à 20 %</p>
            ...
            <div class="faq__wrapper">
                <div class="faq__item expanded">
                    <div class="faq__header">
                        <h3>Quel est le prix d’électrodes de rechange ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Le <strong>prix des électrodes de rechange</strong>, un <strong>accessoire pour défibrillateur essentiel</strong>, peut varier en fonction de plusieurs facteurs tels que la marque, le type (adulte ou enfant) et d'autres spécifications de l'appareil.</p>
                        <p>Chez CardioPro, nous mettons à votre disposition des kits complets incluant les piles et les électrodes à un tarif moyen d'environ 180€ HT.</p>
                        <p>Pour obtenir un devis précis, nous vous recommandons de vérifier les spécificités de votre défibrillateur.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Quel est le prix d’un boitier interne externe?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                ...
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Quel est le prix avec alarme ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Les boîtiers pour défibrillateur, qu'ils soient internes ou externes, ont tendance à présenter un coût supérieur lorsqu'ils sont équipés d'une alarme intégrée. En règle générale, dans la catégorie « <strong>accessoire pour défibrillateur</strong> », le prix augmente proportionnellement à l'ajout d'options supplémentaires.</p>
                        <p>Par exemple, le boîtier mural intérieur, avec alarme intégrée, est proposé au prix de 150€ HT et le boîtier mural extérieur incluant la même option est tarifé à 300€ HT.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Quel est le prix d’une batterie de rechange?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                ...
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>A quoi sert un défibrillateur de formation  ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
