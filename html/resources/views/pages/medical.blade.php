...
<section class="mainScreen">
    ...
    <h1 class="mainScreen__h1">Obligations d’installation des défibrillateurs en Centre de soins</h1>
</section>
...
<section class="mastHead">
    <div class="container">
        <div class="mastHead__inner">
            <p class="mastHead__p">Les prestataires et centres de soins et de santé doivent être équipés de défibrillateurs depuis janvier 2022. Cela concerne les cabinets de médecine générale et spécialisée, les centres d’analyses et tout centre de soins accueillant une clientèle à risque.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Que dit la loi concernant l’obligation du Défibrillateur en Centre de soins ?</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/medical__acsList_1.webp') }} 1920w,
                            {{ asset('images/content/medical__acsList_1_600.webp') }} 700w,
                            {{ asset('images/content/medical__acsList_1_400.webp') }} 500w"
                        src="{{ asset('images/content/medical__acsList_1.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Les <b>centres de soins</b> désignent aussi bien les cabinets des médecins généralistes que ceux des médecins spécialistes. Les centres de radiographie, d’échographie et d’analyses médicales sont également concernés par l’<b>obligation d’installation d’un défibrillateur à compter du 1er janvier 2022</b>. Les centres dentaires et infirmiers, mais aussi de kinésithérapie doivent également prévoir leur mise en place à cette date. Ces lieux accueillent une clientèle à risque, d’où l’importance d’installer un défibrillateur pouvant être aisément utilisé par tous. Les patients se déplacent dans un centre de soin pour leur santé et il est primordial que des défibrillateurs soient présents dans le cas où une personne fait un arrêt cardiaque dans vos locaux de santé. </p>
            <p class="acsList__p">À partir du 1er janvier 2022, les ayants droit de toute personne décédant des suites d’un arrêt cardiaque d’un centre de soins non équipé d’un défibrillateur seront en droit de porter plainte.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="slider__inner">
            <div class="sale__small__header">
                <h2>Pourquoi choisir CardioPro pour l'achat ou la location d'un défibrillateur ?</h2>
            </div>
...
<section class="acsList__obligations pt-50 pb-55">
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Comment équiper votre Centre de soins ?</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/medical__acsList_2.webp') }} 1920w,
                            {{ asset('images/content/medical__acsList_2_600.webp') }} 700w,
                            {{ asset('images/content/medical__acsList_2_400.webp') }} 500w"
                        src="{{ asset('images/content/medical__acsList_2.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Outre l’aspect <b>obligatoire de l’installation d’un défibrillateur</b>, la clientèle à risque est davantage présente dans les centres de soin que partout ailleurs. Conscient de l’importance d’équiper les centres de santé avec des solutions fiables et efficaces, CardioPro vous propose un pack clé en main. Bénéficiez ainsi d’une solution complète incluant l’installation du défibrillateur dans votre soin, mais aussi la formation de votre personnel à son utilisation. Notre pack comprend également les opérations de maintenance et d’entretien du défibrillateur, ainsi que le remplacement illimité du matériel en cas de panne ou d’utilisation. Le défibrillateur est un dispositif médical qui aide à la réanimation des victimes d’arrêt cardiaque. Un massage cardiaque pourra l’accompagner pour augmenter les chances de survie de la victime. </p>
            <p class="acsList__p">Dans tous les cas, les personnes atteintes de troubles cardiovasculaires sont amenées à se rendre chez leur médecin généraliste, chez un spécialiste ou dans tout centre infirmier ou centre d’analyses médicales. Disposer d’un <b>défibrillateur</b> sur place est un véritable atout pour <b>protéger la vie de vos patients</b> et sécuriser votre centre de soin. Un décès par arrêt cardiaque entraîne des conséquences humaines et sociales terribles. Pouvoir tout mettre en œuvre pour réduire au maximum ce genre de scénario et vous aider à sauver des vies est la mission première de CardioPro. Les centres de soin nous semblent être des lieux où l’obligation d’installation d’un défibrillateur est particulièrement évidente. </p>
            <p class="acsList__p">Profitez de notre expertise et de notre solution clé en main pour éviter de lourdes sanctions en cas de décès et d’absence d’équipement. N’oubliez pas qu’à partir du 1er janvier 2022, tous les chefs d’établissement des centres de soins concernés s’exposent à une amende de 75 000 € et à une condamnation de 5 ans d’emprisonnement en cas d’absence de défibrillateur et de décès d’une victime d’un arrêt cardiaque. Des poursuites pour homicide involontaire pourront en effet être envisagées.</p>
        </div>
    </div>
</section>
        ...
        <div class="installer__inner">
            <div class="installer__item">
                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55" fill="none">
                  ...
                  <h2>Où installer le défibrillateur ?</h2>
