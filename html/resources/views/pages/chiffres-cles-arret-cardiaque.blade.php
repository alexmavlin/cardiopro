...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/chiffres_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/chiffres_formuleLocation_600.webp') }} 700w,
                    {{ asset('images/content/chiffres_formuleLocation_400.webp 500w') }} 500w"
            src="{{ asset('images/content/chiffres_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">Les Chiffres Clés de l'Arrêt Cardiaque en France</h1>
</section>
    ...
    <div class="container">
        <div class="mastHead__inner">
            <img    src="{{ asset('images/content/logo_page.webp') }}"
                ...
                title="" 
                class="mastHead__img">
            <p class="mastHead__p">1 arrêt cardiaque sur 4 à lieu dans un lieu publique et une victime n’a seulement 7% de chance de s’en sortir. Lors d’une telle situation, l’utilisation d’un défibrillateur externe automatisé augmente considérablement les chances de survie d’une victime de malaise cardiaque, c’est pourquoi il est nécessaire d'équiper les entreprises et ERP.</p>
        </div>
    </div>
</section>
        ...
        <div class="whatAED__inner">
            <div class="whatAED__content">
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/chiffres_whatAED_1.webp') }}"
                            width="422"
                            height="288"
                            alt=""
                            title="" 
                ...
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/chiffres_whatAED_2.webp') }}"
                            width="439"
                            height="292"
                            alt=""
                            title="" 
