        ...
        <div class="idealPartner__inner">
            ...
            <div class="idealPartner__row">
                <div class="idealPartner__item">
                    ...
                    <h3 class="idealPartner__title">Service complet</h3>
                ...
                <div class="idealPartner__item">
                    ...
                    <h3 class="idealPartner__title">Offres variées</h3>
            ...
            <div class="idealPartner__row">
                <div class="idealPartner__item">
                    ...
                    <h3 class="idealPartner__title">Respect des normes</h3>
                ...
                <div class="idealPartner__item">
                    ...
                    <h3 class="idealPartner__title">Expertise prouvée</h3>
            ...
            <div class="rightDef__row">
                ...
                <div class="rightDef__item">
                    <img    src="{{ asset('images/content/prix_rightDef_4.svg') }}"
                            ...
                            title="" 
                            class="rightDef__img">
                    <h3 class="rightDef__title">Comment calculer le coût total d’un défibrillateur ?</h3>
...
<section class="defReability bg-blue">
    <div class="container">
            ...
            <div class="faq__wrapper">
                <div class="faq__item expanded">
                    <div class="faq__header">
                        <h3><b>30% des défibrillateurs ne fonctionnent pas</b></h3>
                ...
                <div class="faq__item">
                    <div class="faq__header">
                        <h3><b>La fiabilité à long terme, un critère décisif</b></h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                ...
                <div class="faq__item">
                    <div class="faq__header">
                        <h3><b>Cardio Pro, votre partenaire de confiance</b></h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
        ...
        <div class="container">
            ...
            <div class="faq__blue__inner">
                <div class="faq__wrapper">
                    <div class="faq__item expanded">
                        <div class="faq__header">
                            <h3><b>La certification FDA</b></h3>
                            <div class="faq__status--icon"></div>
                        </div>
                        <div class="faq__content">
                    ...
                    <div class="faq__item">
                        <div class="faq__header">
                            <h3><b>Qu’est-ce que la FDA ?</b></h3>
                            <div class="faq__status--icon"></div>
                        </div>
                        <div class="faq__content">
