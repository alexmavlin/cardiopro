...
<section class="mainScreen">
    ...
    <h1 class="mainScreen__h1">Les subventions liées à l'achat de défibrillateur</h1>
</section>
    ...
    <div class="container">
        <div class="mastHead__inner">
            <img    src="{{ asset('images/content/logo_page.webp') }}"
                ...
                title="" 
                class="mastHead__img">
            <p class="mastHead__p">Un défibrillateur est un appareil de secours de grande importance mais peut s’avérer parfois assez onéreux. L’État français offre alors des subventions pour certaines entreprises et ERP dans l’obligation de s’équiper depuis janvier 2022.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="whatAED__inner">
            <div class="whatAED__content">
                <div class="whatAED__item whatAED__item__sub">
                    <img    src="{{ asset('images/content/subventions_whatAED.webp') }}"
                            width="756"
                            height="506"
                            alt=""
                            title="" 
