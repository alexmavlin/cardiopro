...
@section('content')
    <section class="mainScreen">
        <img    srcset="{{ asset('images/content/defibrillateur-cardiaque_formuleLocation.webp') }} 1920w,
                        {{ asset('images/content/defibrillateur-cardiaque_formuleLocation_600.webp') }} 700w,
                        {{ asset('images/content/defibrillateur-cardiaque_formuleLocation_400.webp 500w') }} 500w"
                src="{{ asset('images/content/defibrillateur-cardiaque_formuleLocation.webp') }}"
                width="1600"
                height="580"
                alt=""
                title="" 
    ...
    <div class="container">
        <div class="mastHead__inner">
            <img    src="{{ asset('images/content/logo_page.webp') }}"
                ...
                title="" 
                class="mastHead__img">
            <p class="mastHead__p">Le défibrillateur externe automatique est un appareil de sauvetage qui peut être utilisé en situation d'urgence cardiaque pour sauver des vies. Il fonctionne en délivrant un choc électrique qui stimule le rythme cardiaque. Il existe deux types de défibrillateurs : défibrillateur automatique externe (DAE) et défibrillateur semi-automatique (DSA).</p>
        </div>
    </div>
</section>
        ...
        <div class="whatAED__inner">
            ...
            <div class="whatAED__content">
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/defibrillateur-cardiaque_whatAED_1.webp') }}"
                            width="422"
                            height="288"
                            alt=""
                            title="" 
                ...
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/defibrillateur-cardiaque_whatAED_2.webp') }}"
                            width="439"
                            height="292"
                            alt=""
                            title="" 
