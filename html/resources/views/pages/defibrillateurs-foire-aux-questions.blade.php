...
@section('content')
    ...
    <section class="mainScreen">
        ...
        <h1 class="mainScreen__h1">FAQ Défibrillateurs</h1>
    </section>
        ...
        <div class="container">
            <div class="mastHead__inner">
                <img    src="{{ asset('images/content/logo_page.png') }}"
                    ...
                    title="" 
                    class="mastHead__img">
                <p class="mastHead__p">Un défibrillateur automatisé externe est un appareil de sauvetage qui peut être utilisé en cas d'urgence cardiaque pour sauver la vie d'une personne. Il fonctionne en délivrant un choc électrique dans le muscle cardiaque du patient. CardioPro répond à toutes vos questions sur les défibrillateurs.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="faqRow__inner">
                <h2 class="global__heading">
                    Tout savoir à propos du Défibrillateur
                </h2>
                <div class="faqRow__row">
                    <img    srcset="{{ asset('images/content/faq_page_01.webp') }} 1920w"
                            src="{{ asset('images/content/faq_page_01.webp') }}" 
                            alt=""
                            width="496"
                            height="373"
                            class="faqRow__img">
                    <h2 class="faqRow__h2--mobile">Tout savoir à propos du Défibrillateur</h2>
    ...
    <section class="faqRow">
        <div class="container">
            <div class="faqRow__inner">
                <h2 class="global__heading">
                    FAQ Achat de défibrillateur
                </h2>
                <div class="faqRow__row">
                    <img    srcset="{{ asset('images/content/faq_page_02.webp') }} 1920w"
                            src="{{ asset('images/content/faq_page_02.webp') }}" 
                            alt=""
                            width="496"
                            height="373"
                            class="faqRow__img">
                    <h2 class="faqRow__h2--mobile">FAQ Achat de défibrillateur</h2>
                    <div class="faq" id="faq">
                        <div class="faq__inner">
                            <div class="faq__wrapper">
                                <div class="faq__item">
                                    ...
                                    <div class="faq__content">
                                        <p>Une crise cardiaque ne prévient pas. Si l’efficacité du défibrillateur a largement été prouvée pour sauver une victime d’arrêt cardiaque ou de mort subite, encore faut-il en avoir un à portée de main dans une telle situation.
                                            <strong><a href="{{route('achat-defibrillateur')}}" title="achat de défibrillateur" style="color:#ca1d1f">L’achat d’un défibrillateur </a></strong>permet d’équiper une zone de passage comme une entreprise et de pouvoir <strong>aider les services de secours à sauver des vies</strong>.
                                ...
                                <div class="faq__item">
                                    ...
                                    <div class="faq__content">
                                        <p>Spécialiste de la vente de défibrillateur cardiaque en France, CardioPro propose différentes solutions clés en main.
                                            ...
                                            Pour faciliter votre démarche d’acquisition d’un défibrillateur, notre enseigne a choisi de vous proposer ce service de suivi unique en France pour vous aider à répondre aux <a href="{{route('obligations')}}" title="Obligation installation défibrillateur" style="color:#ca1d1f">obligations légales</a> en termes d’équipement .</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="faqRow__inner">
                ...
                <div class="faqRow__row">
                    <img    srcset="{{ asset('images/content/faq_page_03.webp') }} 1920w"
                            ...
                            height="373"
                            class="faqRow__img">
                    <h2 class="faqRow__h2--mobile">FAQ Location défibrillateur</h2>
                    <div class="faq" id="faq">
                        <div class="faq__inner">
                            <div class="faq__wrapper">
                                <div class="faq__item">
    ...
    <section class="faqRow lastChild">
        <div class="container">
            <div class="faqRow__inner">
                <h2 class="global__heading">
                    Comment définir un établissement recevant du public ?
                </h2>
                <div class="faqRow__row">
                    <img    srcset="{{ asset('images/content/faq_page_04.webp') }} 1920w"
                            src="{{ asset('images/content/faq_page_04.webp') }}" 
                            alt=""
                            width="496"
                            height="373"
                            class="faqRow__img">
                    <h2 class="faqRow__h2--mobile">Comment définir un établissement recevant du public ?</h2>
                    <div class="faq" id="faq">
                        <div class="faq__inner">
                            <div class="faq__wrapper">
                                <div class="faq__item">
                                    <div class="faq__header">
                                        <h3>Les catégories d'ERP et leurs obligations face aux défibrillateurs.</h3>
                                        <div class="faq__status--icon"></div>
                                    </div>
                                    <div class="faq__content">
                                ...
                                <div class="faq__item">
                                    <div class="faq__header">
                                        <h3>Comment définir les catégories ERP ?</h3>
                                        <div class="faq__status--icon"></div>
                                    </div>
                                    <div class="faq__content">
