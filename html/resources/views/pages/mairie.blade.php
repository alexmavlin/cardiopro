...
<section class="mainScreen">
    ...
    <h1 class="mainScreen__h1">Obligations d’installation des défibrillateurs en mairie</h1>
</section>
        ...
        <div class="whatAED__inner">
            <div class="whatAED__content">
                ...
                <div class="whatAED__item">
                    ...
                    <div class="whatAED__content whatAED__content__entreprise">
                        <p class="whatAED__content__p">Un <b>défibrillateur est</b> une machine mise à disposition pour que tout citoyen puisse secourir une victime d’arrêt cardiaque soudain, sans pour autant être médecin. Installer un défibrillateur en <b>mairie et dans les collectivités</b> participe à la sécurisation de la commune et de ses habitants.</p>
                    </div>
                </div>
                <div class="whatAED__item">
                    <div class="entreprise__box">
    ...
    <div class="container">
        <div class="slider__inner">
            <div class="sale__small__header">
                <h2>Pourquoi choisir CardioPro pour l'achat ou la location d'un défibrillateur pour mairies et collectivités ?</h2>
            </div>
    ...
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Zoom sur la législation sur le défibrillateur en mairie</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/mairie__acsList_1.webp') }} 1920w,
                            {{ asset('images/content/mairie__acsList_1_600.webp') }} 700w,
                            {{ asset('images/content/mairie__acsList_1_400.webp') }} 500w"
                        src="{{ asset('images/content/mairie__acsList_1.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Les <b>mairies et les collectivités</b> au sein d'une même ville gèrent souvent plusieurs établissements recevant du public (ERP). Ces établissements sont classés en catégories en fonction de leur capacité d'accueil :</p>
            <ul>
                <li>Catégorie 1 : capacité de plus de 1 500 personnes.</li>
                <li>Catégorie 2 : capacité de 701 à 1 500 personnes.</li>
                <li>Catégorie 3 : capacité de 301 à 700 personnes.</li>
                <li>Catégorie 4 : capacité allant jusqu'à 300 personnes.</li>
                <li>Catégorie 5 : capacité inférieure aux seuils fixés pour la 5ème catégorie.</li>
            </ul>
            <p class="acsList__p">Chaque catégorie est soumise à des <b>obligations d'équipement en défibrillateur</b>. Depuis le 1er janvier 2020, tous les ERP des catégories 1 à 3 doivent obligatoirement être équipés d'un défibrillateur. Cette obligation a été étendue aux ERP de catégorie 4 depuis le 1er janvier 2021 et certains ERP de catégorie 5 ont rejoint la liste depuis le 1 er janvier 2022.</p>
            <p class="acsList__p">Il est important de noter que si une victime d'arrêt cardiaque survenant dans un ERP appartenant à la mairie ne survit pas, en l'absence de défibrillateur, ses ayants droit peuvent déposer une plainte pour homicide involontaire. Une telle procédure pénale pour "violation manifestement délibérée des règles de prudence" peut être sanctionnée par une peine de 5 ans d’emprisonnement et une amende de 75 000 €.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="installer__inner">
            ...
            <div class="installer__item">
                ...
                <p>Ces étapes simples préparent le dispositif à une utilisation immédiate. En cas d’arrêt cardiaque, il suffira d'allumer le DAE et de positionner les électrodes sur la poitrine de la vicmairie</p>
            </div>
        </div>
    </div>
</section>
<section class="acsList__obligations bg-blue pt-50 pb-55">
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Comment équiper votre mairie ?</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/mairie__acsList_2.webp') }} 1920w,
                            {{ asset('images/content/mairie__acsList_2_600.webp') }} 700w,
                            {{ asset('images/content/mairie__acsList_2_400.webp') }} 500w"
                        src="{{ asset('images/content/mairie__acsList_2.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Les élus ont la responsabilité de veiller à la mise en place de <b>défibrillateurs au sein des établissements relevant de la mairie ou de la collectivité</b>. Cette obligation, inhérente à la sécurité et à la prévention des risques, fait partie intégrante de leurs missions. </p>
            <p class="acsList__p">Pour répondre en toute tranquillité à cette exigence légale, optez pour le pack clé en main de CardioPro.  Notre offre inclut tout le matériel nécessaire, un remplacement illimité en cas d’utilisation ou de panne, la livraison et l'installation des défibrillateurs. </p>
            <p class="acsList__p">Cette solution complète peut répondre aux besoins spécifiques des collectivités et <b>mairies en défibrillateurs</b>, vous permettant ainsi de respecter vos obligations en matière d'équipement des ERP et d'assurer la sécurité de vos concitoyens.</p>
            <h3 class="acsList__h2">Expertise et service complets</h3>
            <p class="acsList__p">CardioPro met à votre disposition son expertise pour l'installation des défibrillateurs, la formation à leur utilisation et propose un avantage considérable : un <b>remplacement illimité du matériel en cas de panne ou d'utilisation</b>.</p>
            <h3 class="acsList__h2">Installation optimale</h3>
            <p class="acsList__p">CardioPro vous aide à choisir l’emplacement optimal pour votre défibrillateur tout en assurant une signalétique en conformité avec les règles. </p>
            <p class="acsList__p">Il est à noter que si plusieurs ERP sont dans une même zone, il est envisageable d’installer un défibrillateur externe en commun.</p>
            <h3 class="acsList__h2">Formation et suivi</h3>
            <p class="acsList__p">Après l'installation du défibrillateur, l'équipe de CardioPro assure une formation rapide à son utilisation. De plus, un suivi du matériel est possible sur le court, moyen et long terme.</p>
        </div>
    </div>
</section>
