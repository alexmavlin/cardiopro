...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/lexique_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/lexique_formuleLocation_600.webp') }} 700w,
                    {{ asset('images/content/lexique_formuleLocation_400.webp 500w') }} 500w"
            src="{{ asset('images/content/lexique_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">Lexique</h1>
</section>
    ...
    <div class="container">
        <div class="mastHead__inner">
            <img    src="{{ asset('images/content/logo_page.webp') }}"
                ...
                title="" 
                class="mastHead__img">
            <p class="mastHead__p">Défibrillateur : lexique et définition des différents termes en corrélation avec le mot défibrillateur nécessaires à la compréhension du fonctionnement de l’appareil et les différentes pathologies cardiaques pouvant résulter en son utilisation.</p>
        </div>
    </div>
</section>
<section class="acsList">
    <div class="container">
        <p class="acsList__h2">Arrêt cardiaque soudain (ACS)</p>
        ...
        <p class="acsList__h2">Arythmie et Asystolie</p>
        ...
        <p class="acsList__h2">Chaîne de survie</p>
        ...
        <p class="acsList__h2">Choquer un patient</p>
        ...
        <p class="acsList__h2">Défibrillation externe</p>
        ...
        <p class="acsList__h2">Défibrillateur externe automatique ou semi-automatique (DEA/DSA)</p>
        ...
        <p class="acsList__h2">Défibrillateur Automatisé Externe (DAE)</p>
        ...
        <p class="acsList__h2">Défibrillation précoce</p>
        ...
        <p class="acsList__h2">Mort subite</p>
        ...
        <p class="acsList__h2">Réanimation cardio-pulmonaire (RCP)</p>
        ...
        <p class="acsList__h2">Tachycardie ventriculaire (TV)</p>
