...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/hotel_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/hotel_formuleLocation_600.webp') }} 700w"
            src="{{ asset('images/content/hotel_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">Défibrillateur obligatoire pour les hôtels et restaurants</h1>
</section>
...
<section class="mastHead">
    <div class="container">
        <div class="mastHead__inner">
            <h2 class="mastHead__h2">Conformité légale : le DAE dans l'hôtellerie et la restauration</h2>
            <p class="mastHead__p">Depuis janvier 2022, les hôtels et restaurants, catégorisés en ERP de catégorie 5, sont tenus par la loi de disposer d'un défibrillateur automatique externe (DAE). Accessible à tous, cet équipement essentiel renforce la sécurité en cas d'urgence cardiaque, garantissant une réponse efficace aux besoins des établissements recevant du public.</p>
        </div>
    </div>
</section>
            ...
            <div class="whatAED__content">
                <div class="whatAED__item ">
                    <div class="entreprise__box">
                        <img    src="{{ asset('images/content/hotel_whatAED_1.webp') }}"
                                width="532"
                                height="358"
                                alt=""
                                title=""
                    ...
                    <div class="whatAED__content whatAED__content__entreprise">
                        <p class="whatAED__content__p">Le 1er janvier 2022 est le point de départ rendant les défibrillateurs (DAE ou DSA) obligatoire dans les ERP 5. La fréquentation des personnes dans les hôtels, les restaurants, les campings, les restaurants d'altitude, les villages de vacances et les pensions est relativement importante. À ce titre, il est obligatoire d’installer un défibrillateur dans vos locaux. En effet, tous les hébergements recevant du public ont l'obligation de mettre à disposition de leurs clients un défibrillateur automatique externe.</p>
                    </div>
                </div>
                <div class="whatAED__item">
                    <div class="entreprise__box">
                        <img    src="{{ asset('images/content/hotel_whatAED_2.webp') }}"
                                width="532"
                                height="358"
                                alt=""
                                title=""
                                class="whatAED__img__entreprise__green">
                    </div>
                    <div class="whatAED__content whatAED__content__entreprise">
                        <p class="whatAED__content__p">Si les dates de mise en place peuvent varier selon la capacité des hébergements, sachez que depuis le 1er janvier 2022, une majeure partie des ERP 5 doivent acheter et ainsi installer un défibrillateur. Cet appareil peut être utilisé par tous les citoyens, même non médecins. Sa présence dans vos locaux pourra permettre de sauver une vie ou de donner toutes ses chances à une victime d’un arrêt cardiaque.</p>
                    </div>
                </div>
                <div class="whatAED__item">
                    <div class="entreprise__box">
                    ...
                    <div class="whatAED__content whatAED__content__entreprise">
                        <p class="whatAED__content__p">Cardiopro contribue à cet effort national visant à abaisser le taux de mortalité suite à un arrêt cardiaque, en proposant aux Hotels, Restaurants, ERP et Entreprises des packs de location de défibrillateurs clé en main au prix de 39,00 € par mois.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="slider__inner">
            <div class="sale__small__header">
                <h2>Pourquoi choisir CardioPro pour l'achat ou la location d'un défibrillateur pour votre hotel ?</h2>
            </div>
...
<section class="acsList__obligations bg-blue pt-50 pb-55">
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Zoom sur la législation sur le défibrillateur pour hôtel et restaurant</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/hotel__acsList_1.webp') }} 1920w,
                            {{ asset('images/content/hotel__acsList_1_600.webp') }} 700w,
                            {{ asset('images/content/hotel__acsList_1_400.webp') }} 500w"
                        src="{{ asset('images/content/hotel__acsList_1.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Les <b>hôtels et les restaurants doivent se conformer à l'obligation d'installer un défibrillateur</b>. Cette exigence a été progressivement mise en œuvre en fonction de la capacité d'accueil de chaque établissement. </p>
            <p class="acsList__p">Voici comment cette obligation a évolué au fil des ans :</p>
            <p class="acsList__p">- Depuis le 1er janvier 2020, l'installation de défibrillateur est obligatoire pour :</p>
            <ul>
                <li>Les hébergements proposant plus de 150 chambres pour deux personnes.</li>
                <li>Les restaurants ayant une capacité d’accueil de plus de 300 personnes.</li>
            </ul>
            <p class="acsList__p">- Depuis le 1er janvier 2021, cette obligation s'étend à :</p>
            <ul>
                <li>Les hébergements comprenant entre 50 et 150 chambres pour deux personnes.</li>
                <li>Les restaurants ayant une capacité d’accueil de plus de 200 personnes ou ceux ayant une capacité de moins de 200 personnes dont plus de 100 personnes en sous-sol ou en étage.</li>
                <li>Les restaurants d’altitude (type OA) avec une capacité de plus 20 personnes.</li>
            </ul>
            <p class="acsList__p">- Enfin, depuis le 1er janvier 2022, ont rejoint la liste :</p>
            <ul>
                <li>Les hôtels situés en altitude de moins de 50 chambres.</li>
                <li>Les restaurants d’altitude de moins de 20 personnes.</li>
            </ul>
            <p class="acsList__p">Il est crucial de noter que l'absence de <b>défibrillateur dans votre hôtel ou restaurant</b> expose les ayants droit d'une victime d'arrêt cardiaque sur les lieux à des poursuites judiciaires en cas de décès.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="installer__inner">
            ...
            <div class="installer__item">
                ...
                <p>L'installation du boîtier d'un défibrillateur dépend de l'emplacement et donc, du type de boîtier. Deux scénarios sont possibles :</p>
                <ul>
                    <li>Une installation en intérieur (boîtier mural interne) : il suffit généralement de percer le mur et de le fixer.</li>
                    <li>Une installation en extérieur (boîtier mural externe) : un technicien électricien doit intervenir pour assurer le raccordement au secteur électrique.</li>
                </ul>
            </div>
            <div class="installer__item">
                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55" fill="none">
                ...
                <p>Pour mettre en service le DAE de manière efficace, il convient d'insérer la batterie dans l'appareil avant de procéder aux premiers branchements des électrodes. Ainsi, en cas de besoin, il suffira d'allumer le défibrillateur et de placer les électrodes sur la poitrine de la victime.</p>
            </div>
        </div>
    </div>
</section>
<section class="acsList__obligations bg-blue pt-50 pb-55">
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Comment équiper votre hôtel ou votre restaurant ?</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/hotel__acsList_2.webp') }} 1920w,
                            {{ asset('images/content/hotel__acsList_2_600.webp') }} 700w,
                            {{ asset('images/content/hotel__acsList_2_400.webp') }} 500w"
                        src="{{ asset('images/content/hotel__acsList_2.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Dans un ERP, un défibrillateur doit être visible et accessible. CardioPro vous conseille sur l'emplacement et la signalisation pour faciliter son repérage.</p>
            <p class="acsList__p">Il est à noter que lorsque plusieurs ERP sont sur un même site, l’installation commune d’un défibrillateur externe est envisageable.</p>
        </div>
    </div>
</section>
            ...
            <div class="faq__wrapper">
                <div class="faq__item expanded">
                    <div class="faq__header">
                        <h3>Tous les restaurants sont-ils concernés par la législation DAE ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Non, tous les restaurants ne sont pas concernés par la législation des Défibrillateurs Automatisés Externes (DAE). L'<a href="{{ route('obligations') }}"><span>obligation d'installation d'un DAE</span></a> s'applique uniquement aux restaurants répondant à certains critères spécifiques.</p>
                        <p>Sont donc concernés par cette réglementation :</p>
                        <ul>
                            <li>les restaurants ayant une capacité d'accueil de plus de 200 personnes ;</li>
                            <li>les restaurants dont la capacité est inférieure à 200 personnes mais qui ont plus de 100 personnes en sous-sol ou en étage ;</li>
                            <li>les restaurants d'altitude (type OA).</li>
                        </ul>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Qui est autorisé à utiliser un défibrillateur ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Conformément au décret n°2007-705 du 4 mai 2007, l'<strong>utilisation des Défibrillateurs Automatisés Externes (DAE) est autorisée à toute personne</strong>, indépendamment de son statut de professionnel de la santé ou de son âge.</p>
                        <p>Cette réglementation permet à des individus non-médecins de prendre des mesures cruciales en cas d'arrêt cardiaque. En combinant l'utilisation d’un DAE avec un massage cardiaque, les chances de survie d’une victime augmentent considérablement.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Est-il plus intéressant de louer ou d’acheter un défibrillateur dans un restaurant ou un hôtel ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Le choix entre l'achat et la <a href="{{ route('location-defibrillateur') }}"><span>location d'un défibrillateur</span></a> dans un restaurant ou un hôtel dépend de divers facteurs. L'achat peut être plus avantageux pour des établissements prévoyant une utilisation à long terme. En revanche, la location est plus souple, permettant de s'adapter aux besoins changeants ou aux contraintes budgétaires. De plus, certains contrats de location incluent l’entretien et la maintenance du dispositif.</p>
                        <p>Quel que soit votre choix, l'essentiel est de garantir la conformité aux réglementations, en assurant la disponibilité, la maintenance et la formation du personnel pour assurer une réponse efficace aux urgences cardiaques.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>La maintenance du défibrillateur est-elle comprise dans les packs ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>La <a href="{{ route('maintenance-defibrillateur') }}"><span>prise en charge de la maintenance du défibrillateur</span></a> varie en fonction des packs proposés. Certains contrats de location offrent la maintenance en tant que service inclus, tandis que d'autres peuvent la proposer en option. Chez CardioPro, nous proposons une maintenance à distance grâce à un module supplémentaire pour <strong>faciliter le dépannage et les mises à jour</strong>.</p>
                        <p>Les spécialistes des DAE et DSA proposent généralement des packs personnalisables, permettant aux clients de choisir les services qui leur conviennent le mieux. Ces services peuvent englober la maintenance, l'entretien et d'autres prestations pour assurer la performance et la conformité du dispositif. Il est donc essentiel de vérifier attentivement les détails du contrat pour comprendre les services inclus dans le pack choisi.</p>
                    </div>
                </div>
            </div>
        </div>
