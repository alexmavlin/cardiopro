...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/ehpad_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/ehpad_formuleLocation_600.webp') }} 700w,
                    {{ asset('images/content/ehpad_formuleLocation_400.webp 500w') }} 500w"
            src="{{ asset('images/content/ehpad_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">Obligations d’installation des défibrillateurs en Ehpad</h1>
</section>
...
<section class="mastHead">
    <div class="container">
        <div class="mastHead__inner">
            <p class="mastHead__p">Étant un lieu accueillant une population à haut risque, les EHPAD sont également concernés par les décrets obligeant l’installation de défibrillateurs au sein de leurs établissements, et cela depuis le 1er janvier 2022. Aujourd’hui chaque EHPAD a obligation d’être équipé sous peine de lourdes sanctions juridiques.</p>
        </div>
    </div>
</section>
<section class="whatAED__entreprise bg-blue pt-60 pb-60">
    <div class="container">
    ...
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Que dit la loi concernant l’obligation du Défibrillateur en Ehpad ?</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/ehpad__acsList_1.webp') }} 1920w,
                            {{ asset('images/content/ehpad__acsList_1_600.webp') }} 700w,
                            {{ asset('images/content/ehpad__acsList_1_400.webp') }} 500w"
                        src="{{ asset('images/content/ehpad__acsList_1.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
            ...
            <p class="acsList__p">Afin d’améliorer les chances de survie des  victimes d’arrêt cardiaque en France, le gouvernement met en place de nombreuses mesures sur le plan législatif depuis plusieurs années. Ainsi, les <b>EHPAD sont concernées par l’obligation d’installation de défibrillateurs</b>. En effet, une EHPAD est considéré comme un établissement recevant du public (ERP). À ce titre, les <b>EHPAD</b>, mais également les établissements de soins et autres structures d’accueil pour personnes âgées sont concernés par l’<b>obligation d’installation de défibrillateurs</b>. Pour les établissements de catégorie 4, c’est-à-dire les <b>structures d’accueil pour personnes âgées</b> accueillant entre 25 et 300 résidents et les établissements de santé accueillant plus de 100 patients ou ayant une capacité d’hébergement de 20 lits minimum, l’installation des défibrillateurs doit être faite depuis le 1er janvier 2021. </p>
            <p class="acsList__p">Un délai supplémentaire a été accordé pour les établissements de catégorie 5, c’est-à-dire les structures d’accueil pour personnes âgées accueillant moins de 25 résidents et les établissements de santé accueillant moins de 100 patients ou ayant une capacité d’hébergement de 20 lits maximum. Pour ces établissements, l’installation d’un <b>défibrillateur</b> devra être effectuée avant le 1er janvier 2022.</p>
        </div>
    </div>
</section>
...
<section class="acsList__obligations pt-50 pb-55">
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Comment équiper votre Ehpad ?</h2>
            </div>
            <div class="acsList__img__box">
            ...
            <p class="acsList__p">L’<b>installation de défibrillateurs</b> dans les maisons de retraite et les résidences pour seniors est un enjeu majeur de la santé publique. Première cause de mortalité en France après le cancer, l’arrêt cardiaque fait près de 50 000 victimes chaque année. Pourtant, lorsqu’un défibrillateur est accessible à proximité, il est souvent possible de <b>sauver la personne à temps</b>. En effet, plus de 70 % des arrêts cardiaques se déroulent devant témoins dans des lieux accueillant du public, dans les entreprises, à domicile, etc. Le défibrillateur répond au besoin d’assistance urgent de n’importe quelle victime puisqu’il peut aisément être manipulé par tout citoyen. Pas besoin d’être médecin pour se servir d’un défibrillateur et venir en aide à une personne dans le besoin. Sachant que les maisons de retraite, les EHPAD et les résidences pour seniors accueillent des personnes âgées, mais aussi des visiteurs au quotidien, l’obligation d’installer ce type de dispositif dans ces établissements est une évidence. </p>
            <p class="acsList__p">L’âge moyen des résidents d’une EHPAD est généralement supérieur à 80 ans et les enfants des résidents sont souvent des seniors. Installer un défibrillateur en EHPAD protège ainsi la vie des résidents, mais également de leurs proches venant leur rendre visite. CardioPro vous propose une solution clé en main avec son pack complet. Nous nous occupons de l’installation du défibrillateur dans votre EHPAD et formons votre personnel à l’utilisation de ce type de matériel. De plus, nous vous assurons le remplacement illimité du matériel en cas de panne ou d’utilisation. Sachez également que les opérations de maintenance des défibrillateurs ont été rendues obligatoires par le gouvernement. Vous pouvez confier la maintenance et l’entretien de votre défibrillateur à CardioPro et ainsi vous dédouaner de la responsabilité de son bon fonctionnement.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="installer__inner">
            ...
            <div class="installer__item">
                ...
                <p>Afin de bien mettre en service le <b>DAE</b>, il faut au préalable introduire la <b>batterie dans l’appareil</b> et faire les premiers <b>branchements des électrodes</b> (afin qu’au moment de secourir la victime il n’y ait plus qu’à allumer le DAE et les poser sur la poitrine de la victime).</p>
            </div>
        </div>
    </div>
</section>
