...
<section class="mainScreen">
    <img    srcset="{{ asset('images/content/legislation_formuleLocation.webp') }} 1920w,
                    {{ asset('images/content/legislation_formuleLocation_600.webp') }} 700w,
                    {{ asset('images/content/legislation_formuleLocation_400.webp 500w') }} 500w"
            src="{{ asset('images/content/legislation_formuleLocation.webp') }}"
            width="1600"
            height="580"
            alt=""
            title="" 
    ...
    <h1 class="mainScreen__h1">La législation concernant les défibrillateurs (DAE & DSA)</h1>
</section>
    ...
    <div class="container">
        <div class="mastHead__inner">
            <img    src="{{ asset('images/content/logo_page.png') }}"
                ...
                title="" 
                class="mastHead__img">
            <p class="mastHead__p">Depuis 2020, la législation concernant les défibrillateurs n’a cessé de se durcir. La loi oblige aujourd’hui tous les ERP à être équipé d’un DAE ou d’un DSA, accessible en moins de 5 minutes pour toute personne présente dans l’établissement.</p>
        </div>
    </div>
</section>
        ...
        <div class="whatAED__inner">
            <div class="whatAED__content">
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/legislation_whatAED_1.webp') }}"
                            width="446"
                            height="254"
                            alt=""
                            title="" 
                ...
                <div class="whatAED__item">
                    <div class="whatAED__img__green"> 
                        <img    src="{{ asset('images/content/legislation_whatAED_2.webp') }}"
                                width="351"
                                height="203"
                                alt=""
                                title=""
                        ...
                        <div class="whatAED__content__row">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                                <g clip-path="url(#clip0_3_3907)">
                                  <mask id="mask0_3_3907" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="-1" width="19" height="20">
                                    <path d="M19 -0.0810547H0V18.9189H19V-0.0810547Z" fill="white"/>
                                  </mask>
                                  <g mask="url(#mask0_3_3907)">
                                    <path d="M2.46822 7.83203C3.78877 9.94479 4.75699 12.2336 5.90142 14.3463C10.4792 7.4799 12.2398 5.45517 17.6977 0.613199C18.578 -0.0910946 19.1062 -0.179038 19.0182 -0.00301546C13.8245 5.36696 10.8314 9.59231 6.69395 18.1312C6.16578 18.9235 5.0214 19.2757 4.40518 18.3954C2.82058 15.9305 2.20436 14.6101 0.443664 11.9691C-0.524731 11.0007 0.267655 9.6803 1.14796 8.35965C1.58818 7.65536 2.02828 7.12719 2.4685 7.83148L2.46822 7.83203Z" fill="#C22921"/>
                                  </g>
                                </g>
                                <defs>
                                  <clipPath id="clip0_3_3907">
                                    <rect width="19" height="19" fill="white"/>
                                  </clipPath>
                                </defs>
                              </svg>
                            <p class="whatAED__content__p"><b>Les ERP de catégories 1, 2 et 3 (recevant plus de 300 personnes)</b>à partir du 1er janvier 2020</p>
                        </div>
                        <div class="whatAED__content__row">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                                <g clip-path="url(#clip0_3_3907)">
                            ...
                            <p class="whatAED__content__p"><b>Les ERP de catégorie 4 (recevant moins de 300 personnes)</b>à partir du 1er janvier 2021</p>
                        </div>
                        <div class="whatAED__content__row">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                                <g clip-path="url(#clip0_3_3907)">
                            ...
                            <p class="whatAED__content__p"><b>Les ERP de catégorie 5</b><br>à partir du 1er janvier 2022 (pour les établissements recevant du public, mais au-dessous du seuil minimum fixé par le règlement de sécurité - pour plus d’informations sur les seuils spécifiques aux ERP de 5e catégorie)</p>
                        </div>
                    </div>
                </div>
                <div class="whatAED__item">
                    <img    src="{{ asset('images/content/legislation_whatAED_3.webp') }}"
                            width="544"
                            height="272"
                            alt=""
                            title="" 
