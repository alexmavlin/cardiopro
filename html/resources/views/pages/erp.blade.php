...
<section class="mainScreen">
    ...
    <h1 class="mainScreen__h1">Défibrillateur en ERP : qui est vraiment concerné ?</h1>
</section>
...
<section class="mastHead">
    <div class="container">
        <div class="mastHead__inner">
            <h2 class="mastHead__h2">Quelles catégories d’ERP sont dans l’obligation d’installer des défibrillateurs ?</h2>
            <p class="mastHead__p">Conformément au Code de la construction et de l'habitation, les établissements recevant du public <b>(ERP) de catégorie 1 à 4 sont dans l’obligation d’installer un ou plusieurs défibrillateurs</b>. Pour les ERP de catégorie 5, cette obligation dépend du type d'établissement.</p>
        </div>
    </div>
</section>
<section class="acsList__obligations bg-blue pt-60 pb-55">
    <div class="container">
        <div class="acsList__inner">
            ...
            <h3 class="acsList__h2">Le défibrillateur est-il obligatoire pour les ERP catégories 1, 2 et 3 ?</h3>
            <p class="acsList__p"><b>ERP de catégorie 1 :</b></p>
            <p class="acsList__p">Depuis le 1er janvier 2020, l'<b>installation de défibrillateurs est obligatoire dans les ERP de catégorie 1</b>. Ces établissements peuvent accueillir plus de 1500 personnes. </p>
            <p class="acsList__p">Cette démarche renforce l'accessibilité et la disponibilité de ces dispositifs dans les endroits à forte fréquentation.</p>
            <p class="acsList__p"><b>ERP de catégorie 2 :</b></p>
            <p class="acsList__p">Également depuis janvier 2020, les ERP de catégorie 2, c’est-à-dire pouvant accueillir de 701 à 1500 personnes, ont l’<b>obligation légale d’installer des défibrillateurs.</b> </p>
            <p class="acsList__p">Cette mesure vise à améliorer la réactivité face aux urgences cardiaques, accélérant ainsi la prise en charge des victimes.</p>
            <p class="acsList__p"><b>ERP de catégorie 3 :</b></p>
...
<section class="acsList__obligations pt-50 pb-55">
    <div class="container">
        <div class="acsList__inner">
            <div class="acsList__header acsList__desc">
                <h2>Comment équiper votre ERP de défibrillateurs ?</h2>
            </div>
            <div class="acsList__img__box">
                <img    srcset="{{ asset('images/content/erp__acsList_2.webp') }} 1920w,
                            {{ asset('images/content/erp__acsList_2_600.webp') }} 700w,
                            {{ asset('images/content/erp__acsList_2_400.webp') }} 500w"
                        src="{{ asset('images/content/erp__acsList_2.webp') }}"
                        width="1100"
                        height="740"
                        alt=""
                        title=""
...
<section class="formuleSlider bg-blue pt-45 pb-60">
    <div class="container">
        <div class="slider__inner">
            <div class="sale__small__header">
                <h2>Pourquoi choisir CardioPro pour l'achat ou la location d'un défibrillateur pour votre ERP ?</h2>
            </div>
...
<section class="faq bg-blue faq__prix" id="faq">
    <div class="container">
            ...
            <div class="faq__wrapper">
                <div class="faq__item expanded">
                    <div class="faq__header">
                        <h3>Quelles obligations concernant les DAE en 2023 ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>En 2023, la réglementation exige que les Établissements Recevant du Public (ERP) de catégories 1, 2, 3, 4 et certains de la catégorie 5 soient équipés de Défibrillateurs Automatisés Externes. Le respect de ces normes implique une maintenance rigoureuse, avec des contrôles réguliers, des remplacements périodiques tous les 8 à 10 ans et des vérifications générales annuelles.</p>
                        <p>Les défibrillateurs doivent également être clairement signalés dans les bâtiments et leur enregistrement auprès des autorités est nécessaire pour faciliter leur localisation en cas de besoin.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Vaut-il mieux acheter ou louer son défibrillateur en ERP ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Le choix entre l'achat et la <a href="{{ route('location-defibrillateur') }}"><span>location d'un défibrillateur</span></a> en ERP dépend de divers facteurs et chaque option a ses avantages. L'<a href="{{ route('achat-defibrillateur') }}"><span>achat d’un défibrillateur</span></a> convient pour une utilisation à long terme tandis que la location permet de changer de modèle pour profiter des nouveautés. En outre, la location s'adapte mieux aux budgets limités.</p>
                        <p>Il est essentiel d'évaluer vos besoins et vos contraintes budgétaires pour déterminer la meilleure option tout en garantissant la conformité réglementaire en matière d'installation et de maintenance.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Suis-je obligé de former mon personnel à l’utilisation d’un DAE ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Selon le code du travail, l'employeur est tenu « d'organiser et de dispenser une information sur les risques pour la santé et la sécurité », y compris la conduite à tenir en cas d'accident.</p>
                        <p>Si l'entreprise installe un défibrillateur, il est donc recommandé à l'employeur de former ses salariés à son utilisation pour répondre à cette obligation légale. Cette formation devrait être adaptée au modèle spécifique du défibrillateur choisi.</p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Les défibrillateurs obligatoires en ERP doivent-ils être signalés par des panneaux ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>L'arrêté du 29 octobre 2019 sur la signalétique pour les défibrillateurs indique les modèles graphiques à respecter dans certains établissements recevant du public (ERP). Six panneaux sont ainsi définis :</p>
                        <ul>
                            <li>un pour indiquer la présence d'un défibrillateur dans l'établissement ;</li>
                            <li>quatre pour localiser le dispositif ;</li>
                            <li>un pour fournir des informations administratives et de maintenance sur le défibrillateur.</li>
                        </ul>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Existe-t-il une norme spécifique pour les défibrillateurs en ERP ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Depuis mai 2020, le défibrillateur est devenu un dispositif médical de type III (classe de risque la plus élevée). Cela signifie que les défibrillateurs automatiques externes présents dans les ERP doivent obtenir le marquage CE. Ce marquage prouve leur conformité aux exigences de sécurité et de santé énoncées dans la législation européenne.</p>
                    </div>
                </div>
            </div>
        </div>
