...
<section class="mainScreen">
    ...
    <h1 class="mainScreen__h1">Quelles différences entre un défibrillateur automatique externe DAE et semi-automatique DSA ?</h1>
</section>
...
<section class="mastHead">
    <div class="container">
        <div class="mastHead__inner">
            <p class="mastHead__p">La différence entre un DAE (défibrillateur automatique externe) et un DSA (défibrillateur semi-automatique) réside principalement dans leur degré d’automatisation. Tous deux étant accessibles au grand public en cas d’arrêt cardiaque, l'utilisation du DSA exige toutefois davantage d'implication de l'utilisateur par rapport au DAE.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="faq__blue__inner">
            <div class="faq__wrapper">
                ...
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Qu'est-ce qu'un DSA ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
                        <p>Le Défibrillateur Semi-Automatique (DSA) est un dispositif médical conçu pour <b>rétablir le rythme cardiaque</b> d'une victime en cas d'arrêt cardiaque. </p>
                        <p>À la différence du DAE, le DSA demande une intervention plus active de la part de l'utilisateur. Celui-ci doit délivrer le choc électrique en appuyant sur un bouton, tout en veillant à ce qu'aucune personne ne soit en contact physique avec la victime à ce moment précis. </p>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__header">
                        <h3>Différences DAE et DSA ?</h3>
                        <div class="faq__status--icon"></div>
                    </div>
                    <div class="faq__content">
...
<section class="additionalInfo__difference">
    <div class="container">
        <div class="additionalInfo__inner">
            <h2 class="additionalInfo__h2__mob">L'engagement CardioPro pour votre DAE</h2>
            <h2 class="additionalInfo__h2__desc">CardioPro : votre partenaire idéal pour les défibrillateurs</h2>
            <div class="additionalInfo__row additionalInfo__row__first">
