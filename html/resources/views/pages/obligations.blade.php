...
<section class="mainScreen">
    ...
    <h1 class="mainScreen__h1">Défibrillateur obligatoire : que dit vraiment la loi ?</h1>
</section>
...
<section class="inShort">
    <div class="container">
        <div class="inShort__inner">
...
<section class="acsList__obligations formuleSlider__blue">
    <div class="container">
        <div class="acsList__header">
            <h2>Zoom sur l’obligation légale du défibrillateur en entreprise</h2>
            <p class="">Découvrez en détails les <b>obligations légales relatives à la présence de défibrillateurs</b> en milieu professionnel, garantissant la sécurité de vos employés et le respect de la législation.</p>
        </div>
        <div class="acsList__img__box">
...
<section class="regarding">
    <div class="container">
        <div class="regarding__inner">
            <h2>Quels sont vos obligations concernant votre DAE ?</h2>
            <div class="regarding__list">
                <div class="regarding__row">
                    ...
                    <div class="regarding__item">
                        <h3>Comment entretenir correctement son défibrillateur ?</h3>
                        <p>Pour garantir le bon entretien de votre défibrillateur, il est essentiel de suivre les recommandations du fabricant. En plus de la <b>maintenance obligatoire du défibrillateur</b>, incluant la mise à jour de ses composants et logiciels, nous vous recommandons l'utilisation d'accessoires de contrôle à distance tels que le <a href="https://cardiopro.fr/accessoire/accessoire-defibrillateur-HeartSine-Gateway">HeartSine Gateway</a>. Cela garantit la disponibilité de votre défibrillateur en cas d'urgence.</p>
                        <p>Pour rappel, il est crucial de surveiller la durée de vie de la batterie, qui varie de 1 à 5 ans selon le fabricant, ainsi que l'état des électrodes, qui peuvent se dessécher ou expirer après 2 à 7 ans. </p>
                    </div>
                </div>
                <div class="regarding__row">
                    <div class="regarding__item">
                        <h3>Quels sont vos obligations concernant la signalétique de votre défibrillateur ?</h3>
                        <p>En tant que propriétaire ou gestionnaire d'un établissement ouvert au public, vous êtes dans l’<b>obligation d’installer un défibrillateur</b> et de respecter scrupuleusement les règles de signalisation concernant les DEA.</p>
                        <p>Selon l'Arrêté du 29 octobre 2019, la signalétique doit être conforme aux modèles préétablis et aux dispositions graphiques spécifiques. Vous avez aussi l'obligation de :</p>
                        <ul>
                            <li>installer une signalisation bien visible à chaque entrée de votre établissement ;</li>
                            <li>indiquer précisément l'emplacement du DEA grâce à des affiches conformes ;</li>
                            <li>apposer une étiquette sur le boîtier ou à proximité, qui doit être aisément visible et lisible depuis l'extérieur, tout en garantissant que les informations qu'elle contient restent constamment à jour.</li>
                        </ul>
                    </div>
                    <div class="regarding__item">
