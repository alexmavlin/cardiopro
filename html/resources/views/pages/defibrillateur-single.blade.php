...
<section class="defGallery">
    <div class="container">
        <div class="defGallery__inner">
            <div class="defGallery__content">
                <div class="defGallery__content__col">
                    <div class="defGallery__content__item">
                        <div class="defGallery__item__shadow defGallery__shadow__none"></div>
                        <img    src="{{ asset('images/content/formulepage_whichDevice_1.webp') }}"
                                width="227"
                                height="227"
                                alt=""
                                title="" 
                                class="defGallery__img__1">
                    </div>
                    <div class="defGallery__content__item">
                        <div class="defGallery__item__shadow"></div>
                        <img    src="{{ asset('images/content/single_defGAllery_2.webp') }}"
                                width="131"
                                height="131"
                                alt=""
                                title="" 
                                class="defGallery__img__2">
                    </div>
                    <div class="defGallery__content__item">
                        <div class="defGallery__item__shadow"></div>
                        <img    src="{{ asset('images/content/single_defGAllery_3.webp') }}"
                                width="123"
                                height="123"
                                alt=""
                                title="" 
                                class="defGallery__img__3">
                    </div>
                </div>
                <div class="defGallery__content__main">
                    <div class="defGallery__content__box defGallery__display">
                        <img    src="{{ asset('images/content/formulepage_whichDevice_1.webp') }}"
                                width="227"
                                height="227"
                                alt=""
                                title="" 
                                class="defGallery__img__main__1">
                    </div>
                    <div class="defGallery__content__box">
                        <img    src="{{ asset('images/content/single_defGAllery_2.webp') }}"
                                width="131"
                                height="131"
                                alt=""
            ...
            <div class="defGallery__stat">
                ...
                <div class="defGallery__stat__row defGallery__stat__desc">
                    ...
                    <div class="defGallery__stat__full"></div>
                </div>
                <div class="defGallery__stat__row defGallery__stat__desc">
                    <p class="defGallery__stat__p">Autonomie</p>
                    <div class="defGallery__stat__part defGallery__stat__2"></div>
                    <div class="defGallery__stat__full"></div>
                </div>
                <div class="defGallery__stat__row defGallery__stat__desc">
                    <p class="defGallery__stat__p">Fonctionnalités</p>
                    <div class="defGallery__stat__part defGallery__stat__2"></div>
                    <div class="defGallery__stat__full"></div>
                </div>
            </div>
...
<section class="formuleSlider">
    <div class="container">
        ...
        <div class="formuleSlider__min">
            <h2 class="formuleSlider__min_desc">défibrillateur automatique</h2>
            <div class="formuleSlider__min__list">
                <div class="formuleSlider__min__col">
                    ...
                    <div class="formuleSlider__min__item">
                        ...
                        <p>Livraison rapide et installation</p>
                    </div>
                    <div class="formuleSlider__min__item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="#0039C6">
                            <path d="M8.33359 12.6427L15.9939 4.98242L17.1724 6.16093L8.33359 14.9997L3.03027 9.69649L4.20878 8.51799L8.33359 12.6427Z" fill="white"/>
                          </svg>
                        <p>Électrodes adultes et pédiatriques</p>
                    </div>
                </div>
                <div class="formuleSlider__min__col">
                    <div class="formuleSlider__min__item">
...
<section class="defStat">
    <div class="container">
        <div class="defStat__inner">
            <div class="defGallery__stat">
                <div class="defGallery__stat__row">
                    <p class="defGallery__stat__p">Prise en main</p>
                    <div class="defGallery__stat__part defGallery__stat__1"></div>
                    <div class="defGallery__stat__full"></div>
                </div>
...
<section class="defDescription" id="defDescription">
    <div class="container">
        <div class="defDescription__inner">
            ...
            <div class="defDescription__box ">
                <div class="defDescription__item defDescription__active">
                    <p>Possédant le <b>degré de protection</b> (IP56) le plus élevé des <b>DAE</b> disponibles sur le marché, le <b>défibrillateur automatique Samaritan PAD 360P</b> bénéficie de la technologie biphasique SCOPE, dont les <b>électrodes exclusives</b> émettent des ondes progressives à faible consommation d’énergie qui s’adaptent aux variations d’impédance du patient. <b>Léger, compact et facile d’utilisation</b> (cf guide) il guide le secouriste (même non formé) tout au 
                        long de la réanimation avec des instructions claires, un métronome et des pictogrammes lumineux. Il est ainsi <b>particulièrement recommandé dans les espaces publics</b> (parcs, rives de fleuves), <b>véhicules d’intervention</b> et de secours, milieux aquatiques, <b>clubs extérieurs</b> et <b>activités et loisirs de plein air</b>. Disposant du marquage CE et de la certification FDA, il 
