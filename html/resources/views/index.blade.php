        ...
        <div class="container">
            <div class="getDefibrilators_inner">
                ...
                <div class="getDefibrilators__content">
                    ...
                    <div class="getDefibrilators__bottom">
                        <img    src="{{ asset('images/content/homepage_getDefibrilators_1.png') }}"
                                width="106"
                                height="106"
                                alt=""
                                title=""
        ...
        <div class="safety__inner">
            <div class="container">
                <div class="safety_header">
                    <h2 class="">Commandez dès maintenant vos défibrillateurs pour une sécurité optimisée</h2>
                </div>
        ...
        <div class="container">
            <div class="howItWorks__inner">
                <div class="howItWorks__header">
                    <h2 class="">Comment le défibrillateur peut-il sauver des vies ?</h2>
                    <p class="">4 chiffres éloquents qui soulignent l'importance cruciale d'avoir un défibrillateur à portée de main :</p>
                </div>
                ...
                <div class="faq__wrapper">
                    <div class="faq__item expanded">
                        ...
                        <div class="faq__content">
                            <p>Un défibrillateur est un appareil conçu pour <strong>rétablir le rythme cardiaque normal en cas d'arrêt cardiaque</strong>. Il intervient en administrant un bref choc électrique lorsque le cœur présente un dysfonctionnement grave. Deux électrodes autoadhésives sont placées sur le thorax de la victime pour acheminer l'électricité depuis le boîtier de commande. Le défibrillateur est portable et fonctionne sur batterie.</p>
                        </div>
                    </div>
                    <div class="faq__item">
                        <div class="faq__header">
                    ...
                    <div class="faq__item">
                        ...
                        <div class="faq__content">
                            <p>L'utilisation d'un <strong>défibrillateur grand public</strong> est essentielle en cas d'arrêt cardiaque. Contactez les secours et démarrez un massage cardiaque si la victime ne respire pas.</p>
                            <p>Activez le défibrillateur, suivez les instructions et placez les électrodes. Le défibrillateur évalue le rythme cardiaque et administre un choc si nécessaire.</p>
                            <p>Après chaque choc, reprenez immédiatement le massage cardiaque. Cette alternance continue entre défibrillation et massage cardiaque est cruciale jusqu'à l'arrivée des secours.</p>
                        </div>
                    </div>
                    <div class="faq__item">
                        <div class="faq__header">
                        ...
                        <div class="faq__content">
                            <p>L'installation d'un défibrillateur est cruciale pour sauver des vies, renforcer la responsabilité de votre entreprise et se conformer à la loi dans certains cas.</p>
                            <p>Les statistiques montrent qu'<strong>un défibrillateur augmente les chances de survie jusqu'à 90 %</strong>, contre moins de 10 % sans équipement (en France). Installer un défibrillateur est ainsi essentiel pour lutter contre les accidents cardiovasculaires.</p>
                        </div>
                    </div>
                    <div class="faq__item">
                        <div class="faq__header">
                        ...
                        <div class="faq__content">
                            <p>Une personne est en arrêt cardiorespiratoire lorsque son rythme cardiaque devient irrégulier ou s'arrête, et sa respiration cesse.</p>
                            <p>Avant d'utiliser un défibrillateur, essayez de la stimuler en lui parlant. Si elle ne réagit pas, vérifiez sa respiration en approchant votre visage du sien ou en observant son ventre.</p>
                            <p>Utilisez ensuite rapidement un défibrillateur. Le DAE analysera son état et décidera de la nécessité d'un choc électrique pour rétablir un rythme cardiaque normal ou d'une réanimation cardiopulmonaire manuelle.</p>
                        </div>
                    </div>
                </div>
            </div>
