...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'p_1' => 'nullable|string|max:15000',
            'p_2' => 'nullable|string|max:15000',
            'p_3' => 'nullable|string|max:15000',
            'p_4' => 'nullable|string|max:15000',
            'p_5' => 'nullable|string|max:15000',
            'p_6' => 'nullable|string|max:15000',
            'p_7' => 'nullable|string|max:15000',
            'p_8' => 'nullable|string|max:15000',
            'p_9' => 'nullable|string|max:15000',
            'p_10' => 'nullable|string|max:15000',
        ];
    }
    ...
    {
        return [
            'url.required' => 'This field must be present in request',
        ];
    }
}
